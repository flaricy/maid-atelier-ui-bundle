...
function clientConfig(id: string, entry: string, portableCssModuleIds: boolean): UserConfig {
  ...
  return {
    ...
    dts: false,
    // This standalone distribution ships source alongside the bundle but not
    // a map file. Keep the artifact self-contained instead of emitting a
    // dangling sourceMappingURL reference.
    sourcemap: false,
    clean: false,
